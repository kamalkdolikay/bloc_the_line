defmodule BlocTheLineWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BlocTheLineWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BlocTheLineWeb.Gettext, "errors", msg, opts)
    end
  end
